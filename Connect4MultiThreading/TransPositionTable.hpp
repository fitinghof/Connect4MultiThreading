...
namespace Connect4 {
    ...
    private:
        ...
        // uint_t<S> is a template type providing an usigned int able to fit interger of S bits.
        ...
        static const uint64_t size = next_prime(1 << log_size); // size of the transition table. Have to be odd to be prime with 2^sizeof(key_t)
    ...
    public:
         ...
         */
        void emplace(uint64_t key, value_t value) {
